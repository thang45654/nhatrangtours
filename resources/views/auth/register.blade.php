    ...
    <div class="card mb-0">
        <div class="card-body">
            <a href="index.html" class="brand-logo">
                ...
                <h2 class="brand-text text-primary ms-1">Nha Trang của tôi</h2>
            </a>

            <h4 class="card-title mb-1">Cuộc phiêu lưu bắt đầu từ đây 🚀</h4>
            <p class="card-text mb-2">Giúp quản lý ứng dụng của bạn dễ dàng và thú vị!</p>
                ...
                <div class="mb-1">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="register-privacy-policy">
                            Tôi đồng ý với <a href="#">điều khoản và chính sách bảo mật</a>
                        </label>
                    </div>
                </div>
                <button class="btn btn-primary w-100" tabindex="5">Đăng kí</button>
            </form>
