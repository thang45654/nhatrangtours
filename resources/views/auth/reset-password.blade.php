...
<div class="card mb-0">
    <div class="card-body">
        ...
        <p class="card-text mb-2">Mật khẩu mới của bạn phải khác với các mật khẩu đã sử dụng trước đó</p>
        ...
        <form class="auth-reset-password-form mt-2" action="{{ route('password.update') }}" method="POST">
            ...
            <button class="btn btn-primary w-100" tabindex="3">Đặt mật khẩu mới</button>
        </form>

        <p class="text-center mt-2">
            <a href="auth-login-basic.html"> <i data-feather="chevron-left"></i> Trờ lại đăng nhập </a>
        </p>
    </div>
</div>
<!-- /Reset Password basic -->
