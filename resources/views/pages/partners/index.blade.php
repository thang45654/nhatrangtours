                            ...
                            <div class="card card-congratulation-medal mb-0">
                                <div class="card-body ">
                                    ...
                                    <h3 class="mb-75 pt-50">
                                        <a href="#">{{ $data['total_partners']}} ctv</a>
                                    </h3>
                        ...
                        <div class="col-lg-2 col-sm-6" >
                            <div class="card  mb-0 h-100">
                                <div class="card-body d-flex flex-column align-items-center">
                                    ...
                                    <h3 class="fw-bolder">{{ $data['total_tours']}}</h3>
                        ...
                        <div class="col-lg-2 col-sm-6">
                            <div class="card  mb-0 h-100">
                                <div class="card-body d-flex flex-column align-items-center">
                                    ...
                                    <h3 class="fw-bolder">{{ $data['total_partners']}}</h3>
                        ...
                        <div class="col-lg-2 col-sm-6">
                            <div class="card mb-0 h-100">
                                <div class="card-body d-flex flex-column align-items-center">
                                    ...
                                    <h3 class="fw-bolder">{{ $data['total_tickets']}}</h3>
                        ...
                        <div class="col-lg-2 col-sm-6">
                            <div class="card mb-0 h-100">
                                <div class="card-body d-flex flex-column align-items-center">
                                    ...
                                    <h3 class="fw-bolder">{{ $data['total_revenue']}}</h3>
                        ...
                        <div class="modal-dialog">
                            <form class="add-new-user modal-content pt-0" action="" method="POST">
                                ...
                                <div class="modal-body flex-grow-1">
                                    ...
                                    <button type="submit" class="btn btn-primary me-1 data-submit" id="formSubmitPartner">Xác nhận</button>
